...
inline constexpr Zone ZONE4{ "Zone4_Start", 5.60, 8.00, 4.80, 6.00 };
...
inline constexpr std::array<Waypoint, 1> ENTRY_POINTS{ {
        { 6.40, 5.40, 0.0, 0.215 },
} };
...
// h 轴高度范围与下行加速度峰值优化偏好
inline constexpr double H_MIN                    = 0.215;
inline constexpr double H_MAX                    = 0.44;
inline constexpr double ZONE2_REQUIRED_H         = 0.3;
