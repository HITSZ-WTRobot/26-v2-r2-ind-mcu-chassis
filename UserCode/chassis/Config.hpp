...
// 底盘相关的几何、控制和轨迹参数都集中在这里。
// 调整机械尺寸、限幅或 PID 时优先改这个文件，避免在动作代码里散落魔法数字。
#include "Master.hpp"
...
{
    // 上位机通常给“底盘离地高度”，而 lift 控制使用“相对辅助轮接地高度”。
...
{
// 这些尺寸主要用于台阶动作：判断辅助轮 / 主动轮相对台阶边缘的位置。
