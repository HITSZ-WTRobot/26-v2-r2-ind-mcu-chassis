...
| `0x18` | `StartOfflineTrajectory` | `EnablePcControl && EnableWheelChassis` 且定位已就绪 | 启动离线轨迹跟随 | `traj_id(1..3)`, `mirror(0=normal/1=mirror)`, `reserve x4` |
